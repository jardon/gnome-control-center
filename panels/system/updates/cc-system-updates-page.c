...
#include "cc-system-updates-page.h"
...
G_DEFINE_TYPE (CcSystemUpdatesPage, cc_system_updates_page, ADW_TYPE_NAVIGATION_PAGE)
...
static void
cc_system_updates_page_dispose (GObject *object)
{
  CcSystemUpdatesPage *self = CC_SYSTEM_UPDATES_PAGE (object);
  ...
  G_OBJECT_CLASS (cc_system_updates_page_parent_class)->dispose (object);
}

static void
cc_system_updates_page_class_init (CcSystemUpdatesPageClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);

  object_class->dispose = cc_system_updates_page_dispose;

  // g_type_ensure (CC_TYPE_HOSTNAME_ENTRY);

  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/control-center/system/updates/cc-system-updates-page.ui");

  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, disk_row);
  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, hardware_model_row);
  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, memory_row);
  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, os_logo);
  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, os_name_row);
  // gtk_widget_class_bind_template_child (widget_class, CcSystemUpdatesPage, processor_row);
...
static void
cc_system_updates_page_init (CcSystemUpdatesPage *self)
{
